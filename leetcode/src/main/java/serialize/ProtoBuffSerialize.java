...
public class ProtoBuffSerialize {
    ...
    private static final Codec<User> studentClassCodec = ProtobufProxy.create(User.class, false);
    ...
    public void start() throws IOException {
        ...
        System.out.println(
                "jprotobuf序列化耗时：" + (System.currentTimeMillis() - stime_jpb_encode) + "ms; 总大小：" + bytes.length);
