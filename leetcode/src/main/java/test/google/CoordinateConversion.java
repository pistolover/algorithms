...
public class CoordinateConversion {
    ...
    public static void main(String[] args) {
       Point wgs_gcj_encrypts = wgs_gcj_encrypts(103.627229, 32.755169);
       Point google_bd_encrypt = google_bd_encrypt(wgs_gcj_encrypts.getLat(), wgs_gcj_encrypts.getLng());
       System.err.println(wgs_gcj_encrypts);
       System.err.println(google_bd_encrypt);
    }
